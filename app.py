...
page = st.sidebar.selectbox(
    "Navigation",
    options=["Add a New Task", "Update Existing Task", "Delete a Task", "Reset Database"]
)

# Page 1: Add a New Task
if page == "Add a New Task":
...
# Page 2: Update Existing Task
elif page == "Update Existing Task":
    st.title("✏️ Update Existing Task")
    tasks = get_tasks()
    if tasks:
...
# Page 3: Delete a Task
    ...
    if tasks:
        ...
        task_id_to_delete = st.selectbox(
